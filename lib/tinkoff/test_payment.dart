...
import 'tinkoff_acquiring/lib/tinkoff_acquiring.dart';
import 'tinkoff_acquiring/lib/tinkoff_acquiring_utils.dart';
import 'tinkoff_acquiring_flutter/lib/tinkoff_acquiring_flutter.dart';

const String terminalKey = '1655724316760';
const String password = 'kjety6sjyu93gghw';
...
class TestPaymentTinkoff extends StatefulWidget {
  const TestPaymentTinkoff({Key? key}) : super(key: key);

  @override
  _TestPaymentTinkoffState createState() => _TestPaymentTinkoffState();
}

class _TestPaymentTinkoffState extends State<TestPaymentTinkoff> {
